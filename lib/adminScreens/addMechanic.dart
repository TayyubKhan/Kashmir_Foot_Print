...
class MechanicalDetails extends StatefulWidget {
  const MechanicalDetails({super.key});

  @override
  State<MechanicalDetails> createState() => _MechanicalDetailsState();
}

class _MechanicalDetailsState extends State<MechanicalDetails> {
  bool loading = false;

  List<File?> _image = [];
  final pick = ImagePicker();
  fstorage.FirebaseStorage storage = fstorage.FirebaseStorage.instance;
  DatabaseReference dB = FirebaseDatabase.instance.ref('mechanic');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Add Mechanical Details'),
        centerTitle: true,
      ),
      body: SafeArea(
